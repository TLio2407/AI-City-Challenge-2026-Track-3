...
ANNOTATIONS_DIR = "/media/RAID5Array/backup_home/tindd4/AIC26/PhysicalAI-Traffic-Anomaly-Reasoning/train"
...
training_args = SFTConfig(
    ...
    # NEW: These parameters are now required to live inside SFTConfig
